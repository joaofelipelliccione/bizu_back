...
export class bizuStart1663544418950 implements MigrationInterface {
  name = 'bizuStart1663544418950';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE \`app\` (\`id\` int NOT NULL AUTO_INCREMENT, \`platform\` enum ('Mobile', 'Web') NOT NULL, \`name\` varchar(20) NOT NULL, \`logo\` varchar(255) NOT NULL, \`slogan\` varchar(60) NOT NULL, \`websiteLink\` varchar(255) NOT NULL, \`category\` varchar(40) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`lastUpdate\` datetime NULL, \`countryId\` int NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
